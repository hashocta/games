function CGame(oData,iLevel,iScore){
	...
	s_oStage.addChild(_oExtraScoreAttach);
        ...
        this.stopGame = function() {
            this._bUpdate = false; // Останавливает обновление игры
            createjs.Sound.setMute(true); // Отключает звук игры
        };

        this.startGame = function() {
            this._bUpdate = true; // Возобновляет обновление игры
            createjs.Sound.setMute(false); // Включает звук игры
        };
